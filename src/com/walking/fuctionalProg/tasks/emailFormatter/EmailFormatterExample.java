package com.walking.fuctionalProg.tasks.emailFormatter;
...
* The sender is "sender@mymail.com", the receiver is "receiver@mymail.com" and the signature is
* "Best regards, James Gosling". Here is the message created in accordance with the described format:
...
sender@mymail.com|receiver@mymail.com|The new version of Java works pretty fast!|Best regards, James Gosling*/
public class EmailFormatterExample {
    public static void main(String[] args) {
        ...
        Function<String, String> emailFormatter = text -> String.join("|", sender, receiver, text, signature); // modify the lambda expression
